		...
		<section class="main-regin">
			...
			<div class="right-regin">
				 <div class="item-descripption">
				 	 ...
				 	 <textarea name=""  class="item-input" style="width:496px;height:60px;" id="" cols="30" rows="10"></textarea>
				 </div>
                 <div class="contact">
                 	   <div class="contact-person">
                 	   	  <div>联系人：</div>
                          <input class="contact-person-input" style="width:200px;height:60px;" " type="text" name="emali" value="    " />
                 	   </div>
                 	   <div class="contact-way">
                 	   	 <div>联系方式：</div>
                          <input class="contact-way-input" style="width:200px;height:60px;" " type="text" name="emali" value="    " />
                 	   </div>
                 </div>
                 ...
                 <div class="main-item">
                 	   <div class="item-sort">
                 	   	  <div>物品类型：</div>
                          <input class="item-sort-input" style="width:200px;height:60px;" " type="text" name="emali" value="    " />
                 	   </div>
                 	   <div class="pickup-time">
                 	   	 <div>拾取时间：</div>
                          <input class="pickup-time-input" style="width:200px;height:60px;" " type="text" name="emali" value="    " />
                 	   </div>
                 </div>
